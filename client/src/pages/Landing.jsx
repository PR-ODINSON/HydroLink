...
const Landing = () => {
  ...
  const features = [
    {
      ...
      description:
        "Immutable ledger ensures transparent and tamper-proof hydrogen credit transactions.",
      color: "blue",
    },
    {
      icon: Zap,
      ...
      description:
        "Advanced ML algorithms detect and prevent fraudulent credit activities in real-time.",
      color: "purple",
    },
    {
      icon: QrCode,
      ...
      description:
        "Instant credit verification through secure QR codes for seamless authentication.",
      color: "green",
    },
    {
      icon: Trophy,
      title: "Gamification",
      description:
        "Leaderboards and achievements encourage sustainable hydrogen production practices.",
      color: "orange",
    },
  ];
            ...
            <div className="aspect-video bg-gradient-to-br from-green-50 to-emerald-50 rounded-lg flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-sm text-gray-500 mt-2">
                  Experience the future of green hydrogen credits
                </p>
              </div>
            </div>
          </motion.div>
  ...
  return (
    <div className={`min-h-screen ${isDarkMode ? "dark" : ""}`}>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 w-full">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              >
                Revolutionizing sustainable energy markets through
                blockchain-powered green hydrogen credit verification, trading,
                and retirement platform.
              </motion.p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          >
            ...
            >
              ...
              AI-powered verification to create the most trusted green hydrogen
              credit system.
            </motion.p>
          </motion.div>
                    ...
                    <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8 hover:shadow-xl transition-all duration-500 transform hover:-translate-y-2 h-full flex flex-col relative overflow-hidden">
                      ...
                      <motion.div
                        className={`w-12 h-12 bg-gradient-to-r ${
                          colorClasses[feature.color]
                        } rounded-xl flex items-center justify-center mb-6 relative z-10`}
                        whileHover={{
                          scale: 1.1,
                          rotate: 360,
                        }}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <motion.p
                ...
                viewport={{ once: true }}
              >
                HydroLink is revolutionizing the green hydrogen credit ecosystem
                by providing a transparent, secure, and efficient platform for
                producers, authorities, and buyers.
              </motion.p>
              <motion.div
                className="space-y-4"
                initial={{ opacity: 0, y: 20 }}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              See what our partners and users say about the future of green
              hydrogen credits.
            </p>
          </motion.div>
          ...
          >
            {[
              {
                quote:
                  "HydroLink has revolutionized how we track and trade our green hydrogen credits. The transparency is unmatched.",
              ...
              {
                quote:
                  "The AI-powered fraud detection gives us complete confidence in every transaction. This is the future of clean energy markets.",
              ...
              {
                quote:
                  "Real-time verification and instant transfers have streamlined our entire carbon offset program. Outstanding platform!",
              ...
              >
                {/* Quote decoration */}
                <div className="absolute top-4 left-4 text-6xl text-green-100 font-serif">
                  "
                </div>
      ...
      <section
        id="contact"
        className="py-24 bg-gradient-to-b from-green-50 via-emerald-50 to-green-100 relative overflow-hidden"
      >
        {/* Animated background elements */}
        <div className="absolute inset-0">
          <motion.div
          ...
          />
          <motion.div
            className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-green-300/10 rounded-full blur-3xl"
            animate={{
              x: [0, -80, 0],
              y: [0, 40, 0],
            }}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
          ...
          >
            ...
            >
              <motion.span
                className="bg-gradient-to-r from-green-700 via-emerald-600 to-green-700 bg-clip-text text-transparent"
                animate={{
                  backgroundPosition: ["0% 50%", "100% 50%", "0% 50%"],
                }}
                transition={{
            ...
            <motion.p
              ...
              viewport={{ once: true }}
            >
              Start trading verified green hydrogen credits today and contribute
            ...
            >
              ...
              >
                <Link
                  to="/register"
                  className="bg-green-600 text-white px-8 py-4 rounded-xl hover:bg-green-700 transition-all duration-300 inline-flex items-center group font-semibold shadow-lg hover:shadow-xl relative overflow-hidden"
                >
                  {/* Pulse animation */}
                  <motion.div
